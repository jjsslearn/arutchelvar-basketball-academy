...
function FeesForm({ user }) {
  ...
  const [payingOnlineStudentId, setPayingOnlineStudentId] = useState(null);
  ...
  async function handlePayOnline(studentId, amount) {
    setMessage('');
    ...
    try {
      ...
      const options = {
        ...
        currency: 'INR',
        name: 'Arutchelvar Basketball Academy',
        description: `${category} - ${month}`,
                    ...
                    <tr key={student.student_id} className={isPaid ? 'paid-row' : 'unpaid-row'}>
                      ...
                      <td>
                        {isPaid ? (
                          ...
                          payingOnlineStudentId === student.student_id ? (
                            <span className="pay-inputs">
                              <input
                                type="number"
                                placeholder="Amount"
                                value={onlinePayAmount}
                                onChange={(e) => setOnlinePayAmount(e.target.value)}
                              />
                              <button
                                type="button"
                                onClick={() => {
                                  handlePayOnline(student.student_id, onlinePayAmount);
                                  setPayingOnlineStudentId(null);
                                }}
                              >
                                Pay Online
                              </button>
                            ...
                            <button type="button" onClick={() => setPayingOnlineStudentId(student.student_id)}>
                              Pay Online
                            </button>
                          )
